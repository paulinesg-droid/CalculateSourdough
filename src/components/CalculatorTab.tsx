          ...
          {filteredProducts.map((p) => (
            ...
            >
              ...
              <div className="mt-1 flex items-center justify-between">
                ...
                <a href="#" className="shop-btn cursor-pointer rounded-[10px] border-[1.5px] border-primary bg-transparent px-3 py-1.5 font-sans text-xs font-medium text-primary no-underline transition-all duration-150 hover:bg-primary hover:text-white">
                  {tr.shopNow}
                </a>
              </div>
            </div>
